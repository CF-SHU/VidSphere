...
void Video::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Video::*)()>(_a, &Video::clicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Video::*)()>(_a, &Video::downloadClicked, 1))
            return;
    }
}
